...
function addBook() {
  ...
  } else popup.classList.remove("d-none");
}
  ...
  for (var i = 0; i < bookList.length; i++) {
    bookInfo += `
         <tr>
            ...
            <td>
            <button onclick="deleteProduct(${i})" type="button" class="btn btn-danger dbtn p-2"> <i class="fa-solid fa-trash"></i> Delete</button></td>
